...
// ----------------------------------------------
// Class Cook Ingredients for KMS
// ----------------------------------------------
// Intergrid Tecnologies del Coneixement SL
// by Jordi Berenguer <j.berenguer@intergrid.cat>
// ----------------------------------------------

class cat_cook_ingredients extends mod {

        /*=[ CONFIGURATION ]=====================================================*/

	var $table	= "kms_cat_cook_ingredients";
	var $key	= "id";	
	var $fields = array("status", "language", "name", "family", "creation_date");
	...
	var $can_search = true;
        ...
        function cat_cook_ingredients($client_account,$user_account,$dm) {
