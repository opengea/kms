...
//	var $fields = array("name","type","db_server","login","password");
	 var $fields = array("name","type","db_server","login", "vhost_id");
//	var $readonly = array("expiration_date","registrar","status","sr_entity","name","creation_date","updated_date","authcode");
	...
	var $can_export = false;
       ...
       //*=[ CONSTRUCTOR ]===========================================================*/
        ...
        function isp_databases_check($client_account,$user_account,$dm,$silent) {
...
//                        $this->fields = array("postbox","mailname","status","name","hosting_id");
        ...
        $this->setComponent("xcombo","vhost_id",array("xtable"=>"kms_isp_hostings_vhosts","xkey"=>"id","xfield"=>"name","readonly"=>false,"linkcreate"=>false,"linkedit"=>false,"sql"=>""));
	$this->humanize("vhost_id","Domini");
