...
// ----------------------------------------------
// Class iMarketing Social Posts for KMS
// ----------------------------------------------
// Intergrid Tecnologies del Coneixement SL
// by Jordi Berenguer <j.berenguer@intergrid.cat>
// ----------------------------------------------

class imark_social extends mod {

        /*=[ CONFIGURATION ]=====================================================*/

	var $table	= "kms_imark_social";
	var $key	= "id";	
	var $fields = array("creation_date", "status", "short_message","title","content");
	...
	var $can_duplicate = true;
       ...
       //*=[ CONSTRUCTOR ]===========================================================*/
        ...
        function imark_social ($client_account,$user_account,$dm) {
...
*/
		...
		if ($pic[0]!=$post['picture']) {	
	        $insert="INSERT INTO kms_lib_pictures (`creation_date`,`dr_folder`,`description`,`file`, `album_id`) VALUES (\"".date("Y-m-d")."\",".$folders['id'].",\"".str_replace('"',"'",$post['title'])."\",\"".$post['picture']."\",\"_KMS_PICTURES_ALBUMS_BLOGPICTURES\");";
