...
echo "mod ";              parent::mod($client_account,$user_account,$extranet);
        }
...
if (($_GET['app']=="cp"||$_GET['app']=="cp-reseller")&&!$this->_group_permissions(1)) {
		...
		if ($_GET['app']=="sysadmin") include "/usr/local/kms/tpl/panels/sysadmin/main.php"; else include "/usr/local/kms/tpl/panels/isp_dashboard.php";
