...
class obj extends mod {
	...
	var $key	= "id";	
      ...
      //*=[ CONSTRUCTOR ]===========================================================*/
        ...
        function obj ($client_account,$user_account,$dm) {
...
//		$this->setComponent("multilang","description");
		...
		$this->setComponent("xcombo","parent",array("xtable"=>"kms_obj","xkey"=>"id","xfield"=>"name","readonly"=>false,"linkcreate"=>true,"linkedit"=>true,"sql"=>""));
		$this->setComponent("xcombo","family",array("xtable"=>"kms_obj_fam","xkey"=>"id","xfield"=>"name","readonly"=>false,"linkcreate"=>true,"linkedit"=>true,"sql"=>""));
		$this->setComponent("picture","picture",array("path"=>"/var/www/vhosts/".$this->current_domain."/subdomains/data/httpdocs/files/pictures","url"=>"http://data.".$this->current_domain."/files/pictures","resize_max_width"=>220,"resize_max_height"=>165,"thumb_max_width"=>125,"thumb_max_height"=>125,"scaleType"=>"w"));
                ...
                $this->customOptions[0] = Array ("label"=>"edit fields","url"=>"","ico"=>"addon.gif","params"=>"action=edit_fields","target"=>"_self","checkFunction"=>"");
                $this->action("edit_fields","/usr/local/kms/mod/obj/edit_fields.php");
		$this->onInsert = "onInsert";
		$this->onDelete = "onDelete";
	}
	function onInsert($post,$id) {
		//create table
		$create="CREATE TABLE `kms_obj_usr_".$post['name']."` (
	...
	function onDelete($post,$id) {
                $delete="DROP TABLE `kms_obj_usr_".$post['name']."`";
