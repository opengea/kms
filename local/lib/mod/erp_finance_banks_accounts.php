...
class erp_finance_banks_accounts extends mod {

        /*=[ CONFIGURATION ]=====================================================*/

	var $table	= "kms_erp_finance_banks_accounts";
	var $key	= "id";	
	var $fields = array("id","owner", "description", "bank_name","account","type","expiration_date");
	...
	var $search = true;
       ...
       //*=[ CONSTRUCTOR ]===========================================================*/
        ...
        function erp_finance_banks_accounts ($client_account,$user_account,$dm) {
