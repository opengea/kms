<?php
  ...
  */
  ...
  class geekMail
  {
    ...
    private $_smtpHost      = 'mail.intergrid.cat';
    private $_smtpPass      = 'C0lor1n4';
    private $_smtpPort      = '25';
    private $_smtpTimeout   = 5;
    private $_smtpUser      = 'gestio@intergrid.cat';
    private $_systemEmail   = 'noreply@intergrid.cat';
    private $_subject       = '';
    ...
    */
    private function _sendWithMail()
    {
      ...
      else
      {
        ...
        if (!mail($this->_recipients, $this->_subject, $this->_finalBody, $this->_headerStr,'-f ' . $this->_cleanEmail($this->_headers['From'])))
        {
          return false;
        }
        else
