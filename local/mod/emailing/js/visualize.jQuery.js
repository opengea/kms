...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			colors: ['#00af18','#be1e2d','#ffa200','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744'],
		...
		var createChart = {
			pie: function(){	
				...
				var npc = Math.round(fraction*100)+"%";
				if (npc=="0%") npc="";
			        var labeltext = $('<span class="visualize-label">' + npc + '</span>')
			        	.css(leftRight, 0)
			        	.css(topBottom, 0);
...
//			        	.css('margin-'+topBottom, -labeltext.outerHeight()/2-i*20+10);
					.css('margin-'+topBottom, -labeltext.outerHeight()/2-i*5+10);
...
//			var newKey = $('<ul class="visualize-key"></ul><br>Total:'+dataSum+'<br>');
			var selector = (o.parseDirection == 'x') ? 'tr:gt(0) th' : 'tr:eq(0) th' ;
			self.find(selector).each(function(i){
			$('<li><span class="visualize-key-color" style="background: '+dataGroups[i].color+'"></span><span class="visualize-key-label">'+ $(this).text() +'('+  dataGroups[i].points + ')</span></li>')
					.appendTo(newKey);
			});
		...
		canvasContain.bind('visualizeRefresh', function(){
			self.visualize(o, $(this).empty()); 
                ...
                $('<div class="visualize-total"><h2>'+ dataSum +' emails</h2></div>').appendTo(canvasContain);
