...
<font color="#777777" style="font-weight:normal">
        ...
        <td id="header_right" style="vertical-align:top;padding-right:15px"><p id="header_right">
          ...
          <?=_KMS_ERP_INVOICE?>
	<table><tr><td style="padding-top:20px;text-align:left;font-size:13px;vertical-align:top;">
...
*/?>
      ...
      <div class="rpt_aditionals" id="rpt_additionals">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" id="additionals">
          ...
          <tr>
            <td style="padding-left:15px;padding-top:15px;white-space:normal"><?=$document_data['notes'];?></td>
          </tr>
        </table>
        <br />
      </div>
...
<? $document_data['base']=str_replace("&euro;","",$document_data['base']);?>
	  <table cellpadding="0" cellspacing="0" width="100%" style="border-left:1px solid #ccc;margin-left:10px;padding:5px">
          <tr><td width="150" class="detail_columns" style="text-align:left;padding-left:15px;"><?=_KMS_ERP_REPORTS_INVOICE_BASE?></td><td style="height:25px;text-align:right; padding-right:33px;font-size:13px; vertical-align:top"><b><?=$document_data['base'];?>&nbsp;&euro;</b></td></tr>
