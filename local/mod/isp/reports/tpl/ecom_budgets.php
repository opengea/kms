...
<div class="budget" id="invoice">
  <div class="header" id="header">
    <table class="rptTable" width="100%" border="0" cellpadding="0" cellspacing="0" id="header">
      <tr>
        <td style="vertical-align:top;padding-left:15px;width:500px;font-size:12px"><span style="font-weight: bold"><img src="http://intranet.intergrid.cat/kms/tpl/default/styles/simple/img/logos/logo_intergrid500.png" alt="Intergrid" width="155" /><br />
</td>
