...
$select="SELECT SUM(debit) FROM kms_erp_accounting_bookentries WHERE account_id like '".$account['account']."%' and creation_date like '".$_SESSION['erp_accounting_exercici']."%'";
$res=mysqli_query($this->dm->dblinks['client'],$select);
