...
class ent_creditors extends mod {

        /*=[ CONFIGURACIO ]=====================================================*/

	var $table	= "kms_ent_creditors";
	var $key	= "id";	
	...
	var $notedit = array("dr_folder");
       ...
       //*=[ CONSTRUCTOR ]===========================================================*/
        ...
        function ent_creditors($client_account,$user_account,$dm) {
                parent::mod($client_account,$user_account,$extranet);
        }

        function setup($client_account,$user_account,$dm) {

		$this->multixref("entity_id", "id", "name", "kms_ent_contacts");
//		DESFASSAT $this->xcombo("entity_id", "kms_ent_contacts", "id", "name", false, "");
