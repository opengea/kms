...
class sites_components extends mod {

        /*=[ CONFIGURATION ]=====================================================*/

	var $table	= "kms_sites_components";
	var $key	= "id";	
	var $fields = array("id", "status", "type", "name");
	var $orderby = "id";

       //*=[ CONSTRUCTOR ]===========================================================*/

        function sites_components ($client_account,$user_account,$dm) {
		...
		$this->default_content_type = "web_components";
