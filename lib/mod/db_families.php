...
class db_families extends mod {

        /*=[ CONFIGURATION ]=====================================================*/

	var $table	= "kms_db_families";
	var $key	= "id";	
	var $fields = array("sortorder", "catalog_id", "name", "creation_date");
	...
	var $notedit= array("dr_folder");
      ...
      //*=[ CONSTRUCTOR ]===========================================================*/
        ...
        function db_families ($client_account,$user_account,$dm) {
